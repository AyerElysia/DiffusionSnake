...
DEFAULT_CFG = REPO_DIR / "configs" / "btcv_diffusion_dit_v3.yaml"


def parse_args():
    parser = argparse.ArgumentParser(description="V3 train debug visualization: init / GT / displacement")
    ...
    parser.add_argument("--save_dir", type=str, default=str(ROOT_DIR / "visual" / "v3_debug_init_gt_disp"))
    parser.add_argument("--cfg_file", type=str, default=str(DEFAULT_CFG))
...
# Keep lib.config from parsing our custom debug args.
sys.argv = [sys.argv[0]]
...
def main():
    ...
    full_path = save_dir / f"v3_debug_full_{idx}_{stem}.png"
    zoom_path = save_dir / f"v3_debug_zoom_{idx}_{stem}_i{ARGS.instance}.png"
