...
from ....data import build_spine_dataset, build_dataloader
...
class DetectionTrainer(BaseTrainer):
    ...
    def build_dataset(self, img_path, mode="train", batch=None):
        ...
        return build_spine_dataset(self.args, img_path, batch, self.data, mode=mode, rect=mode == "val", stride=gs)  ###duan 
