...
from ....data import build_dataloader, build_spine_dataset, converter  ###duan
...
class DetectionValidator(BaseValidator):
    ...
    def build_dataset(self, img_path, mode="val", batch=None):
        ...
        ###duan
        return build_spine_dataset(self.args, img_path, batch, self.data, mode=mode, stride=self.stride)
        ###duan
