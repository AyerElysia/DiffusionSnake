...
class PoseValidator(DetectionValidator):
    ...
    def init_metrics(self, model):
        ...
        # Only use hard-coded OKS sigmas when they match the dataset keypoint count.
        # Custom medical pose tasks like BTCV extreme points fall back to uniform sigmas.
        is_pose = self.kpt_shape[1] == 3 and len(OKS_SIGMA) == self.kpt_shape[0]
