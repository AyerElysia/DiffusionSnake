...
# V3.5
echo "Starting V3.5 on GPU 6..."
export CFG_FILE=configs/btcv_diffusion_dit_v3_5_single_overfit.yaml
CUDA_VISIBLE_DEVICES=6 nohup python diffusion_train.py > logs/v3_5_single_overfit_gpu6.log 2>&1 &
echo "V3.5 started, PID: $!"

echo "All GPU 6 V3 jobs started"
