...
3. **查看和理解验证方案**
   - 阅读 `docs/plan/adaptive_points_verification_plan.md`
   - 确认实施细节
...
如果遇到问题，可以：
1. 查看详细文档：`docs/plan/adaptive_points_verification_plan.md`
2. 查看分析报告：`docs/notion/contour_size_vs_burr_analysis.md`
