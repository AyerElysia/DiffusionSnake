...
> ⚠️ **时效性提示（2026-08-08 复核）**：本文档写于 **2026-07-05**，创新点的**论证结构仍然成立**，
> 但其中的战场与超参描述已落后于当前冻结主线。以下四处以仓库根 `README.md` 为准：
>
> | 本文档所述 | 当前主线实况 |
> |------------|--------------|
> | 主战场 BTCV 腹部 CT | VerSe 矢状位椎骨，25 类（C1–C7 / T1–T12 / L1–L6） |
> | 检测器为 YOLO | 离线 LocateAnything（`external_detection [B,N,6]`） |
> | 内层 Euler 约 10 步 | AB2 积分器，2 outer × 4 inner = 8 NFE |
> | `fractions = [1/3, 1/2, 1]` | `fractions = [0.6667, 1.0]` |
>
> 最新主线状态见 `FLOW_MAIN_HANDOVER_STATUS_20260804.md`。
