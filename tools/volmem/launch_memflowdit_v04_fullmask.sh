...
CFG_FILE="configs/volmem/verse_memflowdit_v0_4_fullmask_moonaware_gpu6.yaml"
OUTPUT_DIR="data/outputs/volmem/verse_memflowdit_v0_4_fullmask_moonaware_gpu6"
...
echo "[Launch] MemFlowDiT v0.4 full-mask MoonViT-aware training" | tee -a "$LOG_FILE"
