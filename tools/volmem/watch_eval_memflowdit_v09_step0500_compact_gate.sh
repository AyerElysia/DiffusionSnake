...
SRC=data/outputs/volmem/verse_memflowdit_v0_9_compact_global_gpu6/checkpoints/step_000500.pt
STAGED=/dev/shm/memflowdit_checkpoints/v09_compact_global_step_000500.pt
...
env CUDA_VISIBLE_DEVICES=0 python tools/volmem/eval_memflowdit_parallel.py \
    ...
    --device cuda:0 --max-volumes 3 --seed 20260731 \
...
env CUDA_VISIBLE_DEVICES=1 python tools/volmem/eval_memflowdit_parallel.py \
    ...
    --result-dir "${ROOT}/oracle_local_k4" --device cuda:0 --max-volumes 3 \
...
env CUDA_VISIBLE_DEVICES=4 python tools/volmem/eval_memflowdit_parallel.py \
    ...
    --max-volumes 3 --seed 20260731 --memory-capacity 4 \
