#!/usr/bin/env bash
# Credit-diag per-step: per_step_reward_weight=0.5 shaped reward
# GPU 6, output: data/outputs/credit_diag_perstep05_gpu6/
set +e
...
export CFG_FILE="configs/credit_diag_perstep05_gpu6.yaml"
